...
const Header = ({ siteTitle }) => (
  <header className="lg:px-16 px-6 bg-white flex flex-wrap items-center lg:py-0 py-2">
    <div className="flex-1 flex justify-start items-center">
      ...
      <span className="font-semibold text-xl tracking-tight pl-3"><Link to="/">{ siteTitle }</Link></span>
    </div>
  ...
  <div className="hidden lg:flex lg:items-center lg:w-auto w-full" id="menu">
    <nav>
      <ul className="lg:flex items-center justify-between text-base text-gray-700 pt-4 lg:pt-0">
        <li><a className="lg:p-4 py-3 px-0 block border-b-2 border-transparent hover:border-indigo-400" href="/">Works</a></li>
    ...
    <a href="/about" className="lg:ml-4 flex items-center justify-start lg:mb-0 mb-4 pointer-cursor" alt="About me">
